...
8. **Your message got acked.** Within 120 s, `atm list --pending-ack --json` (native: list) no longer
   shows A, and the partner's ack reply is in your unread list. Observable: seconds, or timeout.
